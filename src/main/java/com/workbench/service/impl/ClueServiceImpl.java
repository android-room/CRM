...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        // ----------------------------------------------------------------
        //经过第二步处理后，客户信息我们已经拥有了，处理其他表的时候，如果要使用到客户的id
        // 直接使用cus.getId();
        // ----------------------------------------------------------------

        //3.通过线索对象提前联系人信息，保存联系人
        ...
        // ----------------------------------------------------------------
        //经过第三步处理后，客户信息我们已经拥有了，处理其他表的时候，如果要使用到联系人的id
        // 直接使用con.getId();
        // ----------------------------------------------------------------
        ...
        for (ClueRemark clueRemark : clueRemarkList) {
            //取出备注信息（主要转换到客户备注信息和联系人备注的就是这个备注信息）
